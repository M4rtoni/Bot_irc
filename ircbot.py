...
class SingleServerIRCBot(SimpleIRCClient):
    ...
    """
    def __init__(self, server_list, nickname, realname, reconnection_interval=60, password = None, ssl = False):
    ...
    def _on_namreply(self, c, e):
        ...
        for nick in e.arguments()[2].split():
            if nick[0] == "@":
                ...
                nick = nick[1:]
                self.channels[ch].set_mode("a", nick)
            elif nick[0] == "~":
                nick = nick[1:]
